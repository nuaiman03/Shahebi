  ...
  <div class="container py-5">
    <div class="row justify-content-center mb-3">
      <div class="col-md-7 col-xl-12">
        <div class="card shadow-0 border rounded-3" style="background-color: #1f1f1f;">
          <div class="card-body">
            <div class="row">
              <div class="col-md-12 col-lg-3 col-xl-3 mb-4 mb-lg-0">
                <div class="bg-image hover-zoom ripple rounded ripple-surface">
                  <img src="assets/img/asxx.jpg" class="w-100" />
                  <a href="#!">
              ...
              <div class="col-md-6 col-lg-6 col-xl-7">
                ...
                <div class="mt-1 mb-0 text-muted small">
                  <p><i class="bi bi-check-circle" style="color: #ffcd6b;"></i> &nbsp; FREE Domain Registration & 1GB SSD Hosting with SSL</p>
              ...
              <div class="col-md-6 col-lg-3 col-xl-2 border-sm-start-none border-start">
                <div class="d-flex flex-row align-items-center mb-1">
                  <h4 class="mb-1 me-1" style="color: white; font-weight: 500;">$13.99</h4>
                  <span class="text-danger"><s>$20.99</s></span>
                </div>
                <h6 style="color: white;">One Time</h6>
