...
<head>
  ...
  <link href="assets/css/da.css" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="index.html"><div class="logo-container">
            ...
            <ul>
              <li class="dropdown"><a href="#"><span>WEBSITE DEVELOPMENT</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                    ...
                    <li><a href="#">PSD to Static Website</a></li>
                    <li><a href="#">Ecommerce Website</a></li>
                    <li><a href="#">Website Support</a></li>
                    <li><a href="#">SSL & Cyber Security</a></li>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            <h3>OUR COMPANY</h3>
            <p class="fst-italic">
              We are a team of experienced professionals who are passionate about developing complex web systems that meet the needs of our clients. We specialize in building customized web solutions that help businesses achieve their goals and thrive in the digital world.
            </p>
            <p class="fst-italic">
              Our mission is to provide our clients with a seamless and stress-free experience from start to finish, and we pride ourselves on our ability to deliver high-quality web systems that exceed our clients' expectations.
            </p>            
