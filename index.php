    ...
    <div class="container" data-aos="fade-up">
        <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
            <div class="col-xl-6 col-lg-8">
                <h1>Powerful <span>Digital</span> Solutions With <span>Shahebi</span> Soft</h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
                ...
                <p class="fst-italic">
                    ...
                    that help businesses achieve their goals and thrive in the digital world.
                </p>
                <p class="fst-italic">
                    Our mission is to provide our clients with a seamless and stress-free experience from start to
            ...
            <div class="col-lg-4 mb-4">
                <div class="card" data-aos="zoom-in" data-aos-delay="100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">We have the knowledge and expertise necessary to create a
                            professional-looking website that is both visually appealing and functional. They can
                            also help you avoid common pitfalls and ensure your website is optimized for search
                            engines and user experience.</p>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card" data-aos="zoom-in" data-aos-delay="200">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">A high-quality website is designed with the user in mind, making it
                            easy to navigate and find the information they need quickly. This improves the user.
                            Your website is an extension of your brand, and a high-quality website can help to
                            reinforce your brand identity and values.</p>
                        <a href="#" class="readmore">Read more </a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card" data-aos="zoom-in" data-aos-delay="300">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">A reputed website company is likely to have a team of experienced
                            professionals with the knowledge and expertise necessary to create a high-quality
                            website. They will have a proven track record of delivering successful projects and can
                            provide valuable insights and recommendations based on their past experience.</p>
                        <a href="#" class="readmore">Read more </a>
                    </div>
                </div>
            </div>
