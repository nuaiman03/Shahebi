...
<!-- ======= Hero Section ======= -->
<section id="mb-app-hero" class="mb-app-hero">
    <div class="container" data-aos="fade-up">
        <div class="row content">
            <div class="col-lg-6" data-aos="fade-right">
                <img src="assets/img/mobile-apps.png" class="img-fluid" alt="">
            </div>
            <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left">
                <h5>Website Services in Cheap Rate</h5>
                <h2><span>Get</span> Your Best <span>Mobile</span> Service From <span>Us</span></h2>
                <a href="#mb-app-services">Check Our Services</a>
            </div>
        </div>
    </div>
...
<!-- ======= Services Section ======= -->
<section id="mb-app-services" class="mb-app-services">
    <div class="container" data-aos="fade-up">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                <div class="icon-box">
                    ...
                    <h4><a href="apps-development.php">Apps Development</a></h4>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
                <div class="icon-box">
                    ...
                    <h4><a href="apps-promotion.php">Apps Promotion</a></h4>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
                <div class="icon-box">
                    ...
                    <h4><a href="apps-support.php">Apps Support</a></h4>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch mt-4  mt-lg-0" data-aos="zoom-in" data-aos-delay="100">
                <div class="icon-box">
                    ...
                    <h4><a href="convert-website.php">Convert Website</a></h4>
