    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
            <div class="col-lg-6" data-aos="fade-right">
                <img src="assets/img/port.png" class="img-fluid" alt="">
            </div>
            <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left">
                <h5 style="color: #ffcd6b; padding-top: 100px;">CHECK OUR PORTFOLIO</h5>
                <h2>Our <span>Happy</span> Clients</h2>
                <p style="color: white; font-weight: 700;">Some example of our honorable clients. Who hire Large iT Solution to made their company website, apps
                    and others services. So you are most welcome.</p>
                <br>
                <a href="#about" class="get-started-btn scrollto">Check Our WORK</a>
            </div>
        </div>
...
<!-- ======= Portfolio Section ======= -->
<section id="portfolio" class="portfolio" style="background: black;">
