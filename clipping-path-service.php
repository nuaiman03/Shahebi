      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left">
            ...
            <h2>Carefully <span>hand-drawn</span> clipping paths <span>for crisp</span>, clean <span>photos</span></h2>
            <p style="color: white;">Put your product on any background. Take tedious, nitty-gritty photo edits off your plate with outsourced clipping path services. You can get large batches of images edited faster and cheaper, in as little as 6 hours.</p><br>
                ...
                <div class="col-lg-4" data-aos="fade-right">
                    ...
                    <div class="icon-box" data-aos="fade-up">
                        ...
                        <div>
                            ...
                            <p style="color: black;">After getting confirmation, we are ready to processing your images.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 pt-4 pt-lg-0" data-aos="fade-left">
                    ...
                    <div class="icon-box" data-aos="fade-up">
                        ...
                        <div>
                            ...
                            <p style="color: black;">Make your client happy  & you can pay us through PayPal, Master Card and Visa.</p>
                        </div>
                    </div>
                    <br><br>
                    <div class="icon-box" data-aos="fade-up">
                        ...
                        <div>
                            ...
                            <p style="color: black;">We make sure that you are one step ahead in this competitive market.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row gy-4">
            <div data-aos-delay="100" data-aos="fade-up" class="col-lg-2">
                <h4 class="title" style="color: #f1b738; text-align: center; font-weight: bold; font-size: 23px;">INVISIBLE MANNEQUIN</h4>
            </div>
            <div data-aos-delay="100" data-aos="fade-up" class="col-lg-2">
                <h4 class="title" style="color: #f1b738; text-align: center; font-weight: bold; font-size: 23px;"">COLOR CORRECTION</h4>
            </div>
            <div data-aos-delay="100" data-aos="fade-up" class="col-lg-2">
                <h4 class="title" style="color: #f1b738; text-align: center; font-weight: bold; font-size: 23px;"">SHADOW REFLECTION</h4>
            </div>
            <div data-aos-delay="100" data-aos="fade-up" class="col-lg-2">
                <h4 class="title" style="color: #f1b738; text-align: center; font-weight: bold; font-size: 23px;"">RETOUCH</h4>
            </div>
            <div data-aos-delay="100" data-aos="fade-up" class="col-lg-2">
                <h4 class="title" style="color: #f1b738; text-align: center; font-weight: bold; font-size: 23px;"">IMAGE MASKING</h4>
            </div>
            <div data-aos-delay="100" data-aos="fade-up" class="col-lg-2">
                <h4 class="title" style="color: #f1b738; text-align: center; font-weight: bold; font-size: 23px;"">CLIPPING PATHS</h4>
            </div>            
        </div>
    </div>
...
<section id="services" class="services-1" style="background: black">
    <div class="container">
        <div class="row gy-4">
            ...
            <div data-aos-delay="100" data-aos="fade-up" class="col-lg-4">
                <h4 class="title" style="padding-top: 7%; color: #f1b738; text-align: center; font-weight: bold; font-size: 23px; text-transform: upercase;">Basic Clipping Path</h4>
                <p style="color: white; text-align: center;">Type of simple background and go for solid object. Usually having a simple curtain or similar background. </p>
        ...
        <div class="row gy-4">
            <div data-aos-delay="100" data-aos="fade-up" class="col-lg-4">
                <h4 class="title" style="padding-top: 7%; color: #f1b738; text-align: center; font-weight: bold; font-size: 23px; text-transform: upercase;">Complex Clipping Path</h4>
                <p style="color: white; text-align: center;">Type is highly used for e-commerce sites and online retailers. Have fur or hair, lots of thin lines and such complex object & required in very narrow areas.</p>
                <div class="text-center">
            ...
            <div data-aos-delay="100" data-aos="fade-up" class="col-lg-4">
                <h4 class="title" style="padding-top: 7%; color: #f1b738; text-align: center; font-weight: bold; font-size: 23px; text-transform: upercase;">Multiple Clipping Path</h4>
                <p style="color: white; text-align: center;">Type of clipping path, advance level methods are required. When object while in multiple clipping path several objects are selected.</p>
                <div class="text-center">
