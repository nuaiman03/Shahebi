    ...
    <div class="container" data-aos="fade-up">
        <div class="row content">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left">
                <h5>Clipping Path Services in Cheap Rate</h5>
                <h2>Carefully <span>hand-drawn</span> clipping paths <span>for crisp</span>, clean <span>photos</span></h2>
                <p>Put your product on any background. Take tedious, nitty-gritty photo edits off your plate with outsourced clipping path services. You can get
                    large batches of images edited faster and cheaper, in as little as 6 hours.</p>
                <br>
...
<section id="clip-ser-pro" class="clip-ser-pro">
    <div class="container" data-aos="fade-up">
        <div class="row justify-content-center feature-icons" data-aos="fade-up">
            <div class="section-title">
                <p>How The CLIPPING PATHS Service Works</p>
            </div>
            <div class="row content">
                ...
                <div class="col-lg-4 pt-4 pt-lg-0" data-aos="fade-left">
                    <div class="icon-box" data-aos="fade-up">
                        ...
                        <div>
                            <h4>Download Completed Images</h4>
...
<!-- ======= Info Section ======= -->
<section id="clip-ser-info" class="clip-ser-info">
    <div class="container">
        <div class="row gy-4">
            <div data-aos-delay="100" data-aos="fade-up" class="col-lg-2">
                <h4>INVISIBLE MANNEQUIN</h4>
            </div>
            <div data-aos-delay="100" data-aos="fade-up" class="col-lg-2">
                <h4>COLOR CORRECTION</h4>
            </div>
            <div data-aos-delay=" 100" data-aos="fade-up" class="col-lg-2">
                <h4>SHADOW REFLECTION</h4>
            </div>
            <div data-aos-delay=" 100" data-aos="fade-up" class="col-lg-2">
                <h4>RETOUCH</h4>
            </div>
        ...
        <div class="row content">
            ...
            <div class="col-lg-8 pt-8 pt-lg-0" data-aos="fade-left">
                ...
                <p>
                    ...
                    <i class="bi bi-caret-right-fill"></i> Single furniture items &nbsp;
                    <i class="bi bi-caret-right-fill"></i> A simple item of clothing &nbsp;<br>
                    <i class="bi bi-caret-right-fill"></i> Other standalone products &nbsp;
                </p>
                <br>
                <a href="#">0.50$ per image | ORDER NOW</a>
            </div>
            <div class="col-lg-1" data-aos="fade-right">
                <!-- Empty Space Here For Design -->
            </div>
    ...
    <div class="container" data-aos="fade-up">
        <div class="row content">
            <div class="col-lg-8 pt-4 pt-lg-0" data-aos="fade-left">
                ...
                <br>
                <a href="#">1$ per image ORDER NOW</a>
            </div>
            <div class="col-lg-3" data-aos="fade-right">
                <img src="assets/img/clip-4.png" class="img-fluid" alt="">
            </div>
        ...
        <div class="row content">
            ...
            <div class="col-lg-8 pt-8 pt-lg-0" data-aos="fade-left">
                ...
                <p>
                    ...
                    <i class="bi bi-caret-right-fill"></i> Strollers &nbsp;
                </p>
                <br>
                <a href="#">3.99$ per image | ORDER NOW</a>
            </div>
            <div class="col-lg-1" data-aos="fade-right">
                <!-- Empty Space Here For Design -->
            </div>
