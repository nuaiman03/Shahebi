    ...
    <div class="container" data-aos="fade-up">
        <div class="row content">
            <div class="col-lg-6" data-aos="fade-right">
                <img src="assets/img/gd.png" class="img-fluid" alt="">
            </div>
            <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left">
                <h5 style="color: #ffcd6b;">Logo Design Services in Cheap Rate</h5>
                <h2>100% <span>Professional</span> and <span>Unique</span> Logo Design <span>Services</span></h2>
                <p style="color: white;">When you needs to have a unique and clear outstanding logo that will launch
                    your brand and gives it a good impression to the potential customers. We’re an online graphic design
                    agency that specializes in logo design, website design, and business branding.</p><br>
    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-3 col-md-4" style="text-align: center;" data-aos="zoom-out" data-aos-delay="100">
                <i class="bi bi-postcard" style="color: orange; font-size: 70px;"></i>
                <br>
                <a href="#about" class="get-started-btn scrollto" style="color: black; font-weight: bold;">Banner Design
                    Services</a>
            </div>
            <!-- End Content 2 -->
...
<section id="info-2" class="info-2" style="background: black;">
    <div class="container text-center" data-aos="fade-up">
        <h3 style="font-weight:800; color: #ffc451; font-style: italic; font-size: 35px; text-transform: uppercase;">The
            Custom Logo Design Service with Best Designers​</h3>
                ...
                <div class="box" style="background: black;">
                    ...
                    <ul>
                        <li style="color: white;"><i class="bi bi-check2-circle" style="color: #ffc451;"></i>&nbsp;One
                            Time Payment</li>
                        <li style="color: white;"><i class="bi bi-check2-circle" style="color: #ffc451;"></i>&nbsp;Logo
                            design concepts: 3</li>
    ...
    <div class="container" data-aos="fade-up">
        <div class="row content">
            <div class="col-lg-7" data-aos="fade-right">
                <h3 style="color: #ffc451;">Request to Logo Design Service</h3>
                <p style="color: #c7c7c7;">Let Us Design A Custom Logo Design For Your Business. We offer a variety of
                    ...
                    are fully satisfied with your logo design.</p>
                <p
            ...
            <div class="col-lg-5 pt-4 pt-lg-0" data-aos="fade-left">
                <ul>
                    <li><i class="bi bi-check2-circle" style="color: #ffc451;"></i>&nbsp; FREE Logo File Formats for Web
                        and Print use</li>
                    ...
                    <li><i class="bi bi-check2-circle" style="color: #ffc451;"></i>&nbsp; Obtain your logo in multiple
