    ...
    <div class="container" data-aos="fade-up">
        <div class="row content">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left">
                ...
                <a href="#fb-mar-pricing">Check Details</a>
            </div>
        </div>
    </div>
...
<!-- ======= Campaign Section ======= -->
<section id="fb-mar-camp" class="fb-mar-camp">
    <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 justify-content-center" data-aos="fade-left">
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                <div class="box">
                    ...
                    <p>1,000 Likes</p>
                    <ul>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;Estimated Reach: Up to 2.5K-4K</li>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;100% Real People Like</li>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;99.99% Target Audience</li>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;Begins Within 1-3 Hours</li>
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                <div class="box">
                    ...
                    <h3>BUSINESS</h3>
                    <div class="price"><sup>$</sup>229</div>
                    <p>5,000 Likes</p>
                    <ul>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;Estimated Reach: Up to 5K-8K</li>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;100% Real People Like</li>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;99.99% Target Audience</li>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;Begins Within 1-4 Hours</li>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;One Time Payment</li>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;24/7 Support</li>
                    </ul>
                    <a href="#">Order Now &nbsp; <i class="bi bi-cart4"></i></a>
            ...
            <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="100">
                <div class="box">
                    ...
                    <p>10,000 Likes</p>
                    <ul>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;Estimated Reach: Up to 12K-20K</li>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;100% Real People Like</li>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;99.99% Target Audience</li>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;Begins Within 1-6 Hours</li>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;One Time Payment</li>
                        <li><i class="bi bi-check2-circle"></i>&nbsp;24/7 Support</li>
                    </ul>
                    <a href="#">Order Now &nbsp; <i class="bi bi-cart4"></i></a>
        ...
        <div class="row content">
            ...
            <div class="col-lg-5 pt-4 pt-lg-0" data-aos="fade-left">
                <ul>
                    <li><i class="bi bi-check2-circle"></i>&nbsp; 99.99% Target Audience</li>
                    <li><i class="bi bi-check2-circle"></i>&nbsp; 100% Real People Like</li>
                    <li><i class="bi bi-check2-circle"></i>&nbsp; Custom Ad budget increase & decrease</li>
                    <li><i class="bi bi-check2-circle"></i>&nbsp; Cost per like (0.06-0.10)$ Global</li>
                    <li><i class="bi bi-check2-circle"></i>&nbsp; Remove Suspends & any others issues</li>
                    <li><i class="bi bi-check2-circle"></i>&nbsp; Highly Trusted & Most Secure Confirmation</li>
