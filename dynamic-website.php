    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-left">
                <ul>
                    <li><i class="ri-check-double-line"></i> Professional unique design and pattern, having control a
                        Dashboard, make content without any IT knowledge.</li>
                    <li><i class="ri-check-double-line"></i> The owner can save and schedule site management time, Can
                        build a unique and eye-catching page or post for site’s growth easily.</li>
                    <li><i class="ri-check-double-line"></i> The administrator can manage visitors in a better way to
                        retain them for long-term such as you provided.</li>
                    <li><i class="ri-check-double-line"></i>You can edit text using different font styles, sizes, and
                        colors as you go to your site.</li>
                    <li><i class="ri-check-double-line"></i>Manage Images from within the system or externally through
                        the admin panel.</li>
                    <li><i class="ri-check-double-line"></i>Add / Edit / Remove site Content with minimum skills and
                        knowledge.</li>
                    <li><i class="ri-check-double-line"></i>International Standard CMS (WordPress/Joomla/Drupal) is
                        available.</li>
                </ul>
            </div>
        </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="tab1">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-6 d-flex content">
                            <p>If any website visitor doesn’t trust you as a reputable company then they will most
                                likely not to do business with you. Our intellectual interface designers and online
                                marketers have conducted multiple tests to find out what works and what doesn’t. Take a
                                look at this test that we can conduct on our own web form.</p>
                        </div>
                    </div>
                </div>
                <!-- End Tab 1 Content -->
                ...
                <div class="tab-pane fade show" id="tab2">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-6 d-flex content">
                            <p>This happens when the messaging on your website doesn’t match up with the expectations
                                which are set by your advertising or does not fulfill the needs of your potential
                                customers. This can bring a negative result within high bounce rates and a low ROI for a
                                website. That is why we will analyze your customer base and for better understand their
                                needs to craft the appropriate messaging online sales strategy for your website. Which
                                could bring a better result for your website?</p>
                        </div>
                    </div>
                </div>
                <!-- End Tab 2 Content -->
                ...
                <div class="tab-pane fade show" id="tab3">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-6 d-flex content">
                            <p>Many times front-end coders and back-end developers take shortcuts and things like slow
                                page load time, incompatibility with specific web browsers or mobile devices and broken
                                pages lead to potential customers leaving your website immediately. That is why we have
                                a better strict development standard that could make our websites compatible as well as
                                fast and ready for search engine optimization.</p>
                        </div>
                    </div>
                </div>
                <!-- End Tab 3 Content -->
                ...
                <div class="tab-pane fade show" id="tab4">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-6 d-flex content">
                            <p>Now-a-days maximum people browse the internet using their smartphone so it’s very
                                important to build a website with handset responsive. Mobile optimization is critical
                                than desktop because it improves usability when browsing with a finger not using a
                                mouse. So, considering user satisfaction one site should have all mobile-friendly
                                usages. And we can help it out.</p>
                        </div>
                    </div>
                </div>
                <!-- End Tab 4 Content -->
